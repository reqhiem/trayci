...
const snapshot: ProviderUsageSnapshot = {
  ...
  plan: null,
  windows: [
    { id: "session", label: "5h", usedPercent: 20, durationMinutes: 300, resetsAt: null, resetDescription: null },
    { id: "weekly", label: "Weekly", usedPercent: 70, durationMinutes: 10_080, resetsAt: null, resetDescription: null }
  ],
  updatedAt: 0,
  source: "oauth",
  error: null
